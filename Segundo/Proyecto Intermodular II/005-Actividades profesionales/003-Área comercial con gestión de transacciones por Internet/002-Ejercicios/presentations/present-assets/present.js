// present.js — navegación, progreso y zoom
(function(){
  ...
  function zoomIn(){ zoom = clamp(+(zoom + ZSTEP).toFixed(2), ZMIN, ZMAX); applyZoom(); }
  function zoomOut(){ zoom = clamp(+(zoom - ZSTEP).toFixed(2), ZMIN, ZMAX); applyZoom(); }
