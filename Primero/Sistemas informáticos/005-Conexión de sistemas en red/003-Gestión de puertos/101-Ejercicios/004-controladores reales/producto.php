  ...
  <main class="wrap">
    ...
    <section class="product">
      ...
      <div class="card gallery">
        <img class="hero-img" src="<?= $fila['imagen']?>" alt="Vista previa del recortable" />
      ...
      <!-- Right: product info -->
      <div class="card">
        <h1 class="p-title"><?= $fila['titulo']?></h1>
        <p class="p-sub">Recortable listo para imprimir · PDF en alta calidad</p>

        <div class="meta-row">
          <span class="pill">Categoría: Animales</span>
    ...
    <section>
      ...
      <div class="grid">
        <article>
          ...
          <div class="card-body">
            <p class="card-title">Triceratops</p>
            <p class="meta"><span class="stars">★★★★☆</span><span class="tag">Animales</span></p>
        ...
        <article>
          <img src="imgcategoria.png" alt="">
          <div class="card-body">
            <p class="card-title">Velociraptor</p>
            <p class="meta"><span class="stars">★★★★☆</span><span class="tag">Animales</span></p>
            <a class="download" href="#">Descargar PDF</a>
          </div>
        </article>
        ...
        <article>
          <img src="imgcategoria.png" alt="">
          <div class="card-body">
            <p class="card-title">Robot Mini</p>
            <p class="meta"><span class="stars">★★★☆☆</span><span class="tag">Robots</span></p>
            <a class="download" href="#">Descargar PDF</a>
          </div>
        </article>
        ...
        <article>
          <img src="imgcategoria.png" alt="">
          <div class="card-body">
            <p class="card-title">Coche Clásico</p>
            <p class="meta"><span class="stars">★★★★☆</span><span class="tag">Vehículos</span></p>
            <a class="download" href="#">Descargar PDF</a>
          </div>
        </article>
      </div>
