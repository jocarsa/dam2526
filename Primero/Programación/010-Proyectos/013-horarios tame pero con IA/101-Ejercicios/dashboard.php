...
// ---- profesores + mapa horario profesor ----
...
// mensajes globales (para mostrar también en cal/profcal)
$msg = "";
$err = "";
			...
			<?php if($action === "cal"): ?>
				<header class="topbar">
					...
					<div class="actions">
						...
						<a class="btn primary"
						   href="ollama.php?course_id=<?php echo (int)$course_id; ?>&model=<?php echo urlencode($_GET["model"] ?? "qwen2.5:3b-instruct"); ?>&return=<?php echo urlencode("dashboard.php?a=cal&course_id=".(int)$course_id); ?>"
						   onclick="return confirm('Se borrará el horario actual del curso y se generará uno nuevo con IA. ¿Continuar?');">
							Generar horario (IA)
						</a>
					</div>
				</header>
