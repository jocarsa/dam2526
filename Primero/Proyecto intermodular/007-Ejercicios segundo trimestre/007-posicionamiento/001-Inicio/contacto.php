<?php
$SEO = [
  "title" => "Contacto | Dudas, sugerencias y propuestas – recortabl.es",
  "description" => "Contacta con recortabl.es para dudas sobre impresión, montaje, descargas o para proponer nuevos recortables.",
  // Evitar indexar formulario suele ser buena idea:
