<?php
$SEO = [
  "title" => "Descargas de recortables en PDF | recortabl.es",
  "description" => "Accede a los recortables disponibles para descargar en PDF. Imprime, recorta y monta juguetes de papel educativos.",
  "og_type" => "website",
  // Si no quieres indexar contenido “semi-privado”, descomenta:
