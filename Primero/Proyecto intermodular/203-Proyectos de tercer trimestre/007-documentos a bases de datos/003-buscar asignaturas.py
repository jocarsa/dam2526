...
MODEL = "llama3.1:8b"   # cambia a: ministral-3:3b / llama3.1:8b / deepseek-r1:1.5b / etc.

MAX_CHARS = 12000000   # recorte de seguridad (evita prompts enormes)
...
def summarize(text: str) -> str:
    ...
    prompt = (
        "En este documento se establece un plan de estudios. "
        "Ese plan de estudios tiene asignaturas"
        "Indica las asignaturas encontradas"
